        ...
        <div className="grid lg:grid-cols-3 gap-12">
              ...
              <div className="bg-white rounded-2xl shadow-lg p-8 mb-8">
                ...
                <div className="space-y-4 text-gray-600">
                  <p>
                    ...
                    ample space for comfortable living in the heart of the UAE.
                  </p>
                  <p>
                    ...
                    neighborhoods, it offers easy access to shopping, dining, entertainment, and business districts.
                  </p>
                  <p>
                    ...
                    Dubai's strategic location and world-class infrastructure make this an ideal investment opportunity.
                  </p>
                </div>
              </div>
          ...
          <div className="lg:col-span-1">
            ...
            >
              {/* Contact Form */}
              <div className="bg-white rounded-2xl shadow-lg p-8 mb-8">
                <h3 className="text-2xl font-bold text-gray-900 mb-6">Contact Our Dubai Agent</h3>
                <div className="space-y-4">
                  ...
                  <textarea
                    ...
                    defaultValue={`I'm interested in ${property.title} in ${property.city}. Please provide more details about this property.`}
                  />
                  <button
                    onClick={() => alert("Thank you for your interest! Our Dubai team will contact you soon.")}
              ...
              <div className="bg-white rounded-2xl shadow-lg p-8">
                <div className="text-center mb-6">
                  ...
                  <p className="text-sm text-gray-500 mt-2">Dubai Real Estate Specialists</p>
                </div>
                <div className="space-y-3 text-center">
                  ...
                  <a 
                    href={`mailto:${COMPANY.email}?subject=Inquiry about ${property.title}&body=I'm interested in the ${property.title} property in ${property.city}. Please provide more details.`}
                  ...
                  <p className="text-sm text-gray-500 mt-4">
                    Licensed: {COMPANY.license} | Dubai, UAE
                  </p>
                </div>
              </div>
            </motion.div>
