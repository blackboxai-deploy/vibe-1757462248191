...
export default function NandiRealtyDubai() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="relative max-w-7xl mx-auto px-4 py-20 text-center">
          ...
          >
            ...
            <p className="text-lg mb-12 text-purple-200 max-w-2xl mx-auto">
              Discover luxury properties across Dubai, Abu Dhabi, and Sharjah. From modern villas to skyline apartments, 
              find your perfect home with Dubai's trusted real estate experts.
            </p>
          </motion.div>
      ...
      {/* Company Information Section - Dubai Focus */}
        ...
        <div className="max-w-7xl mx-auto px-4 py-16">
          ...
          >
            <h2 className="text-3xl font-bold text-gray-900 mb-6">
              Why Choose {COMPANY.name} for Dubai Real Estate?
            </h2>
            <p className="text-lg text-gray-600 mb-8">
              With years of expertise in the UAE real estate market and deep knowledge of Dubai properties, 
              we provide personalized service to help you find the perfect home or investment. Our commitment 
              to excellence and local market expertise makes us your trusted partner in Dubai real estate.
            </p>
            <div className="grid md:grid-cols-3 gap-8">
              <div className="text-center">
                <div className="text-4xl mb-4">🏆</div>
                <h3 className="text-xl font-semibold mb-2">Dubai Market Experts</h3>
                <p className="text-gray-600">Deep knowledge of Dubai neighborhoods and property values</p>
              </div>
              <div className="text-center">
                <div className="text-4xl mb-4">🌟</div>
                <h3 className="text-xl font-semibold mb-2">Premium Properties</h3>
                <p className="text-gray-600">Carefully curated selection of high-quality UAE properties</p>
              </div>
              <div className="text-center">
                <div className="text-4xl mb-4">🤝</div>
            ...
            <div className="mt-12 p-6 bg-purple-50 rounded-xl">
              <p className="text-sm text-gray-600 mb-2">Licensed Real Estate Company in Dubai, UAE</p>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div>
              ...
              <p className="text-sm text-purple-300">
                Licensed Real Estate Company serving Dubai, Abu Dhabi & Sharjah
              </p>
            </div>
            <div>
              ...
              <p className="text-purple-200">Based in {COMPANY.city}</p>
            </div>
            <div>
              <h4 className="text-lg font-semibold mb-4">Property Types in Dubai</h4>
              <ul className="text-purple-200 space-y-2">
                <li>Luxury Dubai Villas</li>
                <li>Downtown Dubai Apartments</li>
